...
public class LoginWithMoqTests
{
    ...
    public void SetUp()
    {
        ...
        _loginRepositoryMock = new Mock<ILogRepository>();
        _userService = new UserService(_userRepositoryMock.Object, _loginRepositoryMock.Object);
    }
    ...
    public void Login_ShouldReturnFalse_AndLogTwice_WhenCredentialsEmpty()
    {
        ...
        _loginRepositoryMock.Verify((mock) => mock.Log(It.IsAny<string>()), Times.Exactly(2));
